...
public:
    ...
    /**
     * True if the connection to the Lingmo DataEngine is valid.
     */
     ...
     */
    Q_PROPERTY(Lingmo5Support::Types::IntervalAlignment intervalAlignment READ intervalAlignment WRITE setIntervalAlignment NOTIFY intervalAlignmentChanged)
    Lingmo5Support::Types::IntervalAlignment intervalAlignment() const
    {
        return m_intervalAlignment;
    }
    void setIntervalAlignment(Lingmo5Support::Types::IntervalAlignment intervalAlignment);

    /**
     * Plugin name of the Lingmo5Support DataEngine
     */
    ...
    /**
     * @returns a Lingmo5Support::Service given a source name
...
public Q_SLOTS:
    void dataUpdated(const QString &sourceName, const Lingmo5Support::DataEngine::Data &data);
...
private:
    ...
    QString m_id;
    int m_interval;
    Lingmo5Support::Types::IntervalAlignment m_intervalAlignment;
    QString m_engine;
    QQmlPropertyMap *m_data = nullptr;
    QQmlPropertyMap *m_models = nullptr;
    Lingmo5Support::DataEngine *m_dataEngine = nullptr;
    std::unique_ptr<Lingmo5Support::DataEngineConsumer> m_dataEngineConsumer;
    QStringList m_sources;
    QStringList m_connectedSources;
    QStringList m_oldSources;
    QStringList m_newSources;
    Changes m_changes;
    QHash<QString, Lingmo5Support::Service *> m_services;
};
