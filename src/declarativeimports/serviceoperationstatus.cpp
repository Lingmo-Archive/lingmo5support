...
void ServiceOperationStatus::setService(Lingmo5Support::Service *service)
{
    ...
    if (service) {
        connect(service, &Lingmo5Support::Service::operationEnabledChanged, this, &ServiceOperationStatus::updateStatus);
    }
...
Lingmo5Support::Service *ServiceOperationStatus::service() const
{
