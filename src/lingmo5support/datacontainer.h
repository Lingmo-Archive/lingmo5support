...
#ifndef LINGMO_DATACONTAINER_H
#define LINGMO_DATACONTAINER_H
...
/**
 * @class DataContainer lingmo/datacontainer.h <Lingmo/DataContainer>
 *
 * @brief A set of data exported via a DataEngine
 *
 * Lingmo5Support::DataContainer wraps the data exported by a DataEngine
 ...
 **/
class LINGMO5SUPPORT_EXPORT DataContainer : public QObject
{
...
public:
     ...
     **/
    void connectVisualization(QObject *visualization, uint pollingInterval, Lingmo5Support::Types::IntervalAlignment alignment);
