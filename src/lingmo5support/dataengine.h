...
#ifndef LINGMO_DATAENGINE_H
#define LINGMO_DATAENGINE_H
...
/**
 * @class DataEngine lingmo5support/dataengine.h <Lingmo/DataEngine>
 *
 * @short Data provider for plasmoids (Lingmo plugins)
 *
 ...
 **/
class LINGMO5SUPPORT_EXPORT DataEngine : public QObject
{
    Q_OBJECT
...
public:
    ...
    Q_INVOKABLE void connectSource(const QString &source,
                                   ...
                                   Lingmo5Support::Types::IntervalAlignment intervalAlignment = Types::NoAlignment) const;
     ...
     **/
    Q_INVOKABLE void
    connectAllSources(QObject *visualization, uint pollingInterval = 0, Lingmo5Support::Types::IntervalAlignment intervalAlignment = Types::NoAlignment) const;
