...
#ifndef LINGMO_DATACONTAINER_P_H
#define LINGMO_DATACONTAINER_P_H
...
public:
    ...
    SignalRelay *
    signalRelay(const DataContainer *dc, QObject *visualization, uint pollingInterval, Lingmo5Support::Types::IntervalAlignment align, bool immediateUpdate);
...
public:
    SignalRelay(DataContainer *parent, DataContainerPrivate *data, uint ival, Lingmo5Support::Types::IntervalAlignment align, bool immediateUpdate);
    ...
    uint m_interval;
    Lingmo5Support::Types::IntervalAlignment m_align;
    int m_timerId;
    bool m_resetTimer;
    bool m_queued;

Q_SIGNALS:
    void dataUpdated(const QString &, const Lingmo5Support::DataEngine::Data &);
