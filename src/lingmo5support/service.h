...
#ifndef LINGMO5SUPPORT_SERVICE_H
#define LINGMO5SUPPORT_SERVICE_H
...
/**
 * @class Service lingmo5support/service.h <Lingmo5Support/Service>
 *
 * @short This class provides a generic API for write access to settings or services.
 *
 * Lingmo5Support::Service allows interaction with a "destination", the definition of which
 ...
 *
 * @code
 * Lingmo5Support::DataEngine *twitter = dataEngine("twitter");
 * Lingmo5Support::Service *service = twitter.serviceForSource("aseigo");
 * QVariantMap op = service->operationDescription("update");
 * op.insert("tweet", "Hacking on lingmo!");
 * Lingmo5Support::ServiceJob *job = service->startOperationCall(op);
 ...
 *
 */
class LINGMO5SUPPORT_EXPORT Service : public QObject
{
    Q_OBJECT
...
Q_SIGNALS:
     ...
     */
    void serviceReady(Lingmo5Support::Service *service);
...
protected:
    ...
    /**
     * By default this is based on the file in lingmo5support/services/name.operations, but can be
